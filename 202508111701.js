 ...
 * 用法：Sub-Store 脚本操作添加，URL后面添加#clear&nx
...
// 清理乱名的正则表达式
const nameclear =
  /(套餐|到期|有效|剩余|版本|已用|过期|失联|测试|官方|网址|备用|群|TEST|客服|网站|获取|订阅|流量|机场|下次|官址|联系|邮箱|工单|学术|官网|卡顿|迷路|USE|USED|TOTAL|EXPIRE|EMAIL)/i;
